...
def Save_Data_MySql(B,C,D,E,F,G,H,I,J,K,L,M,N,O,P,Q,R):  # Function to save data to MySQL database
    ...
    try:
        ...
        mydb = mysql.connector.connect(host="localhost",user="root",password="shreyasnaik#939")
    ...
    try:
        ...
        mydb=mysql.connector.connect(host="localhost",user="root",password="shreyasnaik#939",database="Heart_Data")
        mycursor=mydb.cursor()
